...
void change_pass(char key)
{
    ...
    if(index1 < 4 && pass_f ==0)
    {
        ...
        if(delay++ < 1000)
        {
            clcd_print("_",(0xC0 + (index1)));
        }
        else if(delay++ > 1000 && delay < 2000)
        {
            clcd_print(" ",(0xC0 + (index1)));
        }
        else
            delay = 0;
        if(key == 5)
    ...
    {
        clcd_print("RE ENTER PASSWORD",(0x80 + (0)));
        if(delay++ < 1000)
        {
            clcd_print("_",(0xC0 + (index2)));
        }
        else if(delay++ > 1000 && delay < 2000)
        {
            clcd_print(" ",(0xC0 + (index2)));
        }
        else
            delay = 0;
        if(key == 5)
    ...
    else if(index1 == 4 && index2 == 4)
    {
        ...
        if(pass_f == 2)
        {
            clcd_print("CHANGE PASSWORD ",(0x80 + (0)));
            clcd_print("    FAILURE     ",(0xC0 + (0)));
