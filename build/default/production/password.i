    ...
    if(pass_f && j == 4)
    {
        ...
        else
        {
            ...
            while(1)
            {
                ...
                clcd_print("FOR ",(0xC0 + (0)));
                clcd_putch((sec%10)+48,(0xC0 + (7)));
                clcd_putch((sec/10)%10+48,(0xC0 + (6)));
                clcd_putch((sec/100)+48,(0xC0 + (5)));
                clcd_print("SECONDS",(0xC0 + (9)));
                if(sec == 0)
                {
                    GIE = 0;
                    PEIE = 0;
