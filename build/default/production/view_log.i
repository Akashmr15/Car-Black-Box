...
void view_log(char key)
{
    static char i=0;
    if(lap==0 && overflow==0)
        clcd_print("NO LOGS FOUND", (0x80 + (1)));
    ...
    if(lap || overflow)
    {
    clcd_print("LOGS", (0x80 + (6)));
    clcd_putch((i+1)+48, (0xC0 + (0)));
    clcd_print(".", (0xC0 + (1)));
    clcd_putch(read_external_eeprom(i*10+0), (0xC0 + (2)));
    clcd_putch(read_external_eeprom(i*10+1), (0xC0 + (3)));
    clcd_print(":", (0xC0 + (4)));
    clcd_putch(read_external_eeprom(i*10+2), (0xC0 + (5)));
    clcd_putch(read_external_eeprom(i*10+3), (0xC0 + (6)));
    clcd_print(":", (0xC0 + (7)));
    clcd_putch(read_external_eeprom(i*10+4), (0xC0 + (8)));
    clcd_putch(read_external_eeprom(i*10+5), (0xC0 + (9)));
    clcd_print(":", (0xC0 + (10)));
    clcd_putch(read_external_eeprom(i*10+6), (0xC0 + (11)));
    clcd_putch(read_external_eeprom(i*10+7), (0xC0 + (12)));
    clcd_print(":", (0xC0 + (13)));
    clcd_putch(read_external_eeprom(i*10+8), (0xC0 + (14)));
    clcd_putch(read_external_eeprom(i*10+9), (0xC0 + (15)));
    }
}
